        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
          <div className=" lg:col-span-3">
            ...
            <p className="mt-4 text-sm text-gray-100">
              ...
              Financial-asset Traders in Nigeria (FT9ja) and empower them. They
              trade with our funds, and we split the profit. It’s really a
              win-win! We want to see retail Traders succeed. Trade with peace
              of mind by trading with our money. Get rid of the fear of losing
              your money as well as the problems of trading a small account
              size.
            </p>
          ...
          <div className="grid grid-cols-1 gap-10 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-2">
            <div>
              ...
              <nav className="flex flex-col mt-4 text-sm text-gray-100 space-y-2">
                <a className="hover:opacity-75" href="mailto:info@ft9ja.com">
                  Email Us
                </a>
            ...
            <div>
              ...
              <nav className="flex flex-col mt-4 text-sm text-gray-100 space-y-2">
                ...
                <a
                  className="hover:opacity-75"
                  href="https://wa.me/2348138462394"
                >
                  Chat on Wastapp
                  <br />
                  (+2348138462394)
